...
//while (city1.isCityDead == false) {
  ...
  prompt('What is your choice ? : ').then(
    function(answer) {
      ...
      switch (answer) {
        case "1":
          console.log(`How many corn would you trade for gold ? Min:0 Max:${city1.divinity.corn}`);
          prompt('\n -->').then(
            function(answer2) {
          ...
          break;
        case "2":
          console.log(`How many gold would you trade for corn ? Min:0 Max:${city1.divinity.gold}`);
          prompt('\n -->').then(
            function(answer2) {
          ...
          break;
        case "3":
          console.log(`How many units would you like to create ? Min:0 Max:${Math.floor(city1.divinity.gold/100)}`);
          prompt('\n -->').then(
            function(answer2) {
          ...
          break;
        case "4":
          console.log(`How many churches you wanna buy ? Min:0 Max:${city1.divinity.gold/350}`);
          prompt('\n -->').then(
            function(answer2) {
          ...
          break;
        case "5":
          console.log(`Get ready cause this is war !`); //TODO Qu'es ce que l'utilisateur rentre ?
          prompt('\n -->').then(
            function(answer2) {
